import { app, BrowserWindow, dialog, Menu, MenuItem, MenuItemConstructorOptions } from 'electron';
...
const createApplicationMenu = () => {
    ...
    },
    {
      ...
      submenu: [
        ...
        },
        {
          ...
          click(item:any, focusedWindow:BrowserWindow) {
            if (focusedWindow) focusedWindow.getBrowserView().webContents.toggleDevTools();
          }
        }
      ],
    }
  ...
  if (process.platform === 'darwin') {
    ...
    (<MenuItemConstructorOptions[]>windowMenu.submenu).push(
      { type: 'separator' },
      {
