...
declare var Grid: (tag: types.app.UI.ElementPromise, a: grid_attributes, c: Array<GridItem>) => Grid;
declare var GridItem: (tag: types.app.UI.ElementPromise, a: griditem_attributes, c?: string | types.app.UI.ElementPromise[] | undefined) => GridItem;
