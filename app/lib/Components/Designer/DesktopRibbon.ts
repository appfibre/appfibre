...
let DesktopRibbon : types.Component = function inject(app:types.IAppLoaded) {
        ...
        render() {
            return super.render(    [ 'div'
                                    ...
                                    , [   [ 'div'
                                        ...
                                        , [ 'label', null, this.state.selectedContext && this.state.selectedContext.control ? this.state.selectedContext.control.url + ' ' + this.state.selectedContext.control.method : '(none)' ]
